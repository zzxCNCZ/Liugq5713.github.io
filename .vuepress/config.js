    ...
    sidebar: {
      '/fe/': [
        ...
        },
        {
          title: 'HTML',
          collapsable: true,
          children: ['dom', 'crossorigin', 'svg', 'script', 'image', 'html', 'iframe', 'select'].map(i => `html/${i}`)
        },
        {
          title: 'Node',
          collapsable: true,
      ...
      '/algorithm/': [
        ...
        },
        {
          title: '题目',
          collapsable: false,
          children: ['', 'search', 'dp', '13RomanToInteger', '17LetterCombinationsOfAPhoneNumber', 'link', 'tree']
        }
      ],
      '/': ['']
    }
