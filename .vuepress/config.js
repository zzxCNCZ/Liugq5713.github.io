    ...
    sidebar: {
      '/fe/': [
        ...
        },
        {
          title: 'HTML',
          collapsable: true,
          children: ['crossorigin', 'svg', 'image', 'html', 'iframe', 'select'].map(i => `html/${i}`)
        },
        {
          title: 'Node',
          collapsable: true,
      ...
      '/lib/': [
        {
          title: 'Vue',
          collapsable: false,
          children: ['', 'base', 'component', 'lifecycle', 'reactivity', 'sfc', 'reuse', 'project', 'src-code-vfor', 'store', 'store-communication', 'qa'].map(i => `vue/${i}`)
        },
        {
          title: '其他',
          collapsable: false,
